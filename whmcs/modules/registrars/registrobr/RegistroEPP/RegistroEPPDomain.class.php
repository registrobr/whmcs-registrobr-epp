...
class RegistroEPPDomain extends RegistroEPP {
    ...
    private function _getXMLupdateNameserver($OldNameservers,$NewNameservers){
        ...
        // ticketNumber nao deve ser enviado no update de nameservers.
        // Dominos ja publicados nao possuem ticket ativo - enviar o
        // ticketNumber causa EPP 2303 (Objeto nao existe).
        $request.='
        <clTRID>'.mt_rand().mt_rand().'</clTRID>
        </command>
        </epp>
